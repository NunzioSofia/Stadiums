...
function addGetStadiumListener() {

    $(document).on('click', 'button.linkToStadium', getStadium);
}
...
function getStadiums() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            printStadiumsAdv(data.stadiums);
        }
    });
}
function getStadium() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            printStadiumsAdv(stadiums);
        }
    });
}
function printStadiumsAdv(stadiums) {
